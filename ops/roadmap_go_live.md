...
| **Stato cashout (B5)** 📌 | **Indice di avanzamento** (aggiornato a ogni PR): 2.0 ✅ · 2.1-A ✅ · B0 ✅ · B1 ✅ · **B2.1 ✅ · B2.2 ✅ · B2.3 ✅ · B2.4a ✅ · B2.4b-1 ✅ · B2.4b-2 ✅ · B2.5 ✅** · 2.1-C ⬜. **PR rimanenti per chiudere B5: 1** — 2.1-C (copy-pattern action). **Il cashout è ora attivo end-to-end** (trigger → router → bridge → executor → residual handler) — **+ deliverable finale** (spiegazione completa con esempi numerici reali + possibili aggiunte di funzionalità). Nota: i moduli puri (resolver/router/adapter/identità) sono pronti ma **inerti** finché B2.4 non li cabla nel runtime. | Checklist sempre visibile |
